...
{
	//Make all card types
	CardType* plus1 = new CardType(1, 1);
	CardType* plus2 = new CardType(1, 2);
	CardType* plus3 = new CardType(1, 3);
	CardType* plus4 = new CardType(1, 4);

	CardType* minus1 = new CardType(2, 1);
	CardType* minus2 = new CardType(2, 2);
	CardType* minus3 = new CardType(2, 3);
	CardType* minus4 = new CardType(2, 4);

	CardType* stealBoard = new CardType(3, 0);
	CardType* stealHand = new CardType(4, 0);

	CardType* removeBoard = new CardType(5, 0);
	CardType* removeHand = new CardType(6, 0);
